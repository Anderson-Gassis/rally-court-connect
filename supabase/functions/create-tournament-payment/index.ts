...
serve(async (req) => {
  ...
  try {
    ...
    console.log("Creating tournament payment for user:", user.email);
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode: "payment",
      success_url: `${req.headers.get("origin")}/tournament-success?session_id={CHECKOUT_SESSION_ID}`,
    ...
    console.log("Tournament payment session created:", session.id);
