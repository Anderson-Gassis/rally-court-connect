        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/kourt_ify/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-tennis-blue" aria-label="Instagram">
              ...
              <a href="https://www.linkedin.com/company/kourtify/about/?viewAsMember=true" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-tennis-blue" aria-label="LinkedIn">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/termos" className="text-gray-600 hover:text-tennis-blue">Termos de Serviço</Link>
              </li>
              <li>
                <Link to="/privacidade" className="text-gray-600 hover:text-tennis-blue">Política de Privacidade</Link>
              </li>
            </ul>
          </div>
        </div>
